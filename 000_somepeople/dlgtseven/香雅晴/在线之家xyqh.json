{
    ...
    "homeContent":"0",
    "firstpage": "1",
    "class_url": "https://zxzj.vip/vodshow/{cateId}-{area}-{by}-{class}-{lang}----{catePg}---{year}.html",
    "class_name": "电影&美剧&韩剧&日剧&泰剧&动漫",
    "class_value": "1&2&3&4&5&6",
    "filterdata": {
      "1": [
      {
        "key": "cateId",
    ...
    "cat_arr_rule": ".stui-vodlist__thumb&&a",
    ...
    "sea_arr_rule": ".stui-vodlist__thumb&&a",

    "sea_is_jsoup":"1", 
    
    "sea_pic": "a&&data-original",
    ...
    "proj_actor": ".stui-content__detail&&p,1&&Text",
    
    "proj_plot": ".stui-content__detail&&p,-1&&Text",
    
    "tab_arr_rule": ".stui-pannel-box&&.stui-vodlist__head",
 
    "tab_title": "Text",
    
    "list_arr_rule": "body&&.stui-content__playlist.clearfix",
